...
export const HeaderCustomBot = (props) => {
    return <View style={{ marginTop: StatusBar.currentHeight, backgroundColor: '#fff', flexDirection: 'row', height: 50, justifyContent: 'center', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#CFE1ED', }}>
...
export const Form = (props) => {
    return <View style={{
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 5 }}>
            ...
            <Text style={{ fontSize: 16, color: '#000', fontWeight: 'bold' }}>Tên: </Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 5 }}>
            ...
            <Text style={{ fontSize: 16, color: '#000', fontWeight: 'bold' }}>Thời gian: </Text>

            <Text numberOfLines={1} style={{ fontSize: 16, color: '#000', width: (deviceWidth - 200) / 3 }}>{moment(props.item?.createAt).format('DD/MM-H:mm')}</Text>
        </View>
